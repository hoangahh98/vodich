...
export class TeamMemberController {
  ...
  async addTeamMember(@Res() res: Response, @Param('id') id: string, @Body() body: Record<string, string | string[]>) {
  ...
  async editTeamMember(@Res() res: Response, @Param('teamId') teamId: string, @Param('memberId') memberId: string, @Body() body: Record<string, string>) {
  ...
  async deleteTeamMember(@Res() res: Response, @Param('teamId') teamId: string, @Param('memberId') memberId: string, @Body('month') month: string) {
